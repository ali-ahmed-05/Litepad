...
let zpad_address = "0x0523E43C8345932F42B822321913c03e2a630e05" // put zpad address here <-
...
async function main() {
  ...
  staking = await Staking.deploy(zpad_address, rewardToken.address); // number -> baserate reward per block

...
//     uint256 private _ether;
//     //APY

//     uint public blocksPerYear = 94620000;
...
//         _ether = IERC20Metadata(_token).decimals();
...
//     function UpdateBaseRatePerBlock(uint256 _baseRatePerBlock) public onlyOwner {
...
//         require(detail.stakeTime + 4 hours < block.timestamp ,"you can apply for WhiteList after 4 hours");

...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x29e5AE7C1c3D3ce86cA42EA7598fe56cC30d9C93;
...
contract LitePad is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xfa8CF932a38b995aDe51F38111f6a0Ab62cd96A9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 500000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LitePad Token";
    string private _symbol = "LPD";
